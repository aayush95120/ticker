...
// $(function() {
//     initializeClock("loan-test",starttime);
// });
(function() {
...
(function() {
  ...
  newClickEvent = function() {
    return $('#loan-test').click(function(event) {
      event.preventDefault();
...
function initializeClock() {
  ...
  //     $.each(data, function(i, loan) { //for each loan loop
  //       var p = loan.principal; // principal for the loan
  ...
  //       var sumTotal = sumTotal + (netPerSec*dt); //how much interest accumulated/sec
  //     });

  //   }, "json");

  //   $("#ticker").innerHTML = "$" + sumTotal;
  //   // ---------------------repeated secondly----------------------
  // }
