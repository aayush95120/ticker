...
$(function() {
  ...
  $.ajax("/loans.json",function(data) {
    $("#loan-test")
      .append("Principal " + data.principal)
      .append("Interest " + data.interest);
  },"json");
...
function loadDoc() {
  ...
  xhttp.onreadystatechange = function() {
    //THIS LINE RIGHT HERE WORKS, COMMENT IT TO TEST OTHER JS FILES
    if (xhttp.readyState == 4 && xhttp.status == 200) {
      document.getElementById("test").innerHTML = xhttp.responseText;
    }
  };
  xhttp.open("GET", "/loans.json", true);
  xhttp.send();
}
